		...
		<Modal
			...
			header={
				isFailed ? (
					...
					<Dialog.Title
						as="h3"
						className="flex flex-col items-center border-b pt-32 pb-24 border-eae9f0"
					>
		...
		>
			...
			<div className="px-68 pt-32 pb-64">
				<div
					...
					onClick={connectThroughPolkadotExtension}
				>
					<PolkadotExtensionLogo />
					<p className="flex-1 text-base pl-16 text-494853">
						{isFailed ? "Try Again" : "Polkdot{.js} extension"}
					</p>
...
const ErrorContent = () => {
	return (
		<div className="px-32 text-base2 text-7b7986 mb-12">
			...
			<OrderBefore order={2}>
				<div>
					Follow this <a className="text-primary">guide</a> to create a new
					account or import from existing account.
				</div>
			</OrderBefore>
		</div>
	);
