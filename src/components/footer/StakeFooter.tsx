      ...
      <div className="container flex flex-between h-full">
        <div>
          ...
          <div className="flex items-center gap-32 mt-24">
            <a href="https://discord.gg/6QHVY4X"
              rel="noreferrer"
              target="_blank">
            ...
            <div className="flex items-center text-16 text-primary font-medium gap-12">
              ...
              <Spacing className="border-r border-d6d3de"
                h={20} />
        ...
        <div className="flex flex-col gap-24">
          ...
          <Button className="h-52 w-[193px] rounded-[42px] text-14 text-fff font-semibold"
            style={{background: "linear-gradient(328.08deg, #645AFF -40.69%, #E40C5B 36.17%, #FF4C3B 79.87%)"}}>Subscribe</Button>
        </div>
      </div>
    </div>
  );
