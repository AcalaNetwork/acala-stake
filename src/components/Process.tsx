...
export const CircleProcess: FC<{ process: number }> = ({ process }) => {
  ...
  const leftDeg = useMemo(() => (formatPorcess <= 50 ? (formatPorcess / 100) * 360 + 225 : 45), [formatPorcess]);
  const rightDeg = useMemo(() => (formatPorcess > 50 ? (formatPorcess / 100) * 360 + 45 : 225), [formatPorcess]);
