...
export const SwitchSelector: FC<SwitchSelectorProps> = React.memo(({ className, children, value, onChange }) => {
  return (
...
export const SwitchSelectorItem: FC<SwitchSelectorItemProps> = React.memo(
  ({ active, className, children, value, onClick }) => {
    ...
    return (
      <div className={getSwitchSelectorItemClassName(active, className)} onClick={handleClick}>
        {children}
      </div>
    );
  }
