...
export const StakeConfirm: FC = () => {
  const { setStep, mintAmount, stakingToken, liquidToken, params, available } = useContext(StakeProviderContext);
  ...
  return (
    <Card variant='border' className='w-[630px] px-[48px] pt-36 pb-38 mx-auto'>
      <div className='w-full mb-[38px] text-494853'>
        <p className='text-center my-10 font-medium text-28 leading-[27px]'>Confirm Transaction</p>
      </div>
      <FormPanel>
        <ListItem>
