...
import { InformationCircleIcon, ChevronLeftIcon } from '@heroicons/react/outline';
    ...
    <Card variant='border' className='w-[630px] px-[55px] py-32 mx-auto'>
          ...
          <div className='text-14 font-medium'>
            ...
            <div className='flex flex-between'>
              ...
              <span className='text-494853'>
                Available via Bridge: <span className=' text-2e2d33 font-medium'>***** {activeToken}</span>
              </span>
            </div>
          </div>
        }
      >
        ...
        <div className='mt-8 text-grey-3'>
          Minimum amount required: <span className=' text-494853 font-medium'>1 {activeToken}</span>
        </div>
      </FormPanel>
      <Spacing h={16} />
      <FormPanel
            ...
            <Popover
              content={
                <div className='w-[180px]'>
                  LDOT received can be automatically used as collateral to borrow aUSD credit. You can withdraw unused
                  LDOT any time.
                </div>
              }
            >
          ...
          <ListItem>
            <ListLabel>
              <div className='flex flex-center'>
                You will receive
                <Popover content={<div className='w-[180px]'>LDOT represents DOT staked + DOT yield earned</div>}>
                  <InformationCircleIcon className='w-14 h-14 text-[#b1b0bc]' />
                </Popover>
              </div>
            </ListLabel>
            ...
            <ListLabel>
              <div className='flex flex-center'>
                ...
                <Popover
                  content={
                    <div className='w-[180px]'>
                      Polkadot transaction fees are paid in DOT. Acala transaction fees can be paid in any available
                      token, please go to Setting to change it.
                    </div>
                  }
                >
                  <InformationCircleIcon className='w-14 h-14 text-[#b1b0bc]' />
      ...
      <Spacing h={20} />
      <FormPanel label={<div className='text-18 font-semibold text-black'>Yield & Rewards</div>}>
        <List>
          <div className='px-20 pb-11'>
              ...
              <ListLabel>
                <div className='flex flex-center'>
                  ...
                  <Popover
                    content={
                      <div className='w-[180px]'>
                        The APY is adjusted daily based on the on-chain staking rewards, and specific APY displayed is
                        subject to change. This already includes 1% staking fee that will be contributed to the Acala
                        Treasury.
                      </div>
                    }
                  >
            ...
            <ListItem>
              ...
              <ListValue>
                <FormatBalance balance={mintAmount?.pay.times(new FixedPointNumber(apy))} human token={activeToken} />
              </ListValue>
            </ListItem>
          </div>
