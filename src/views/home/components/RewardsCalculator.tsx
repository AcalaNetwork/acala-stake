...
export const RewardsCalculator = memo(() => {
  ...
  return (
    <div className='text-center bg-fff pt-68 pb-72'>
      <div className='text-[36px] leading-30 font-bold text-333'> Calculate Rewards</div>
      <Spacing h={37} />
      <TabsContext init='acala'>
        <Tabs init='acala'>
          <Tab onChange={setType as TabProps['onChange']} value='acala'>
            STAKE {getTokenName(acalaHomaConsts.stakingToken)}
          </Tab>
          <Tab onChange={setType as TabProps['onChange']} value='karura'>
          ...
          <div className='mt-44 flex w-full h-[108px] text-16 border border-grey-5 rounded-[24px] pt-20 pb-18 pl-60 text-grey-2'>
            ...
            <div className='flex-1 flex flex-col items-start'>
              ...
              <BalanceValue
                ...
                token={activeToken}
              />
              <span className='text-14 leading-17 mt-12 text-grey-3'> Est. Earning/Month </span>
            </div>
            <div className='flex-1 flex flex-col items-start'>
              <FormatBalance
